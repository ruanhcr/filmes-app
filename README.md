...
<br>São utilizados conceitos da arquitetura MVVM onde são implementados: [Live Data](https://developer.android.com/topic/libraries/architecture/livedata?hl=pt-br): Obervables, MutableLiveData e MediatorLiveData, 
